...
public class Act_ResetPasswordValidation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_password_validation);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Bundle extras = getIntent().getExtras();
        email = extras == null ? "" : extras.getString("email");

        VillaTextView lblEmail = (VillaTextView)findViewById(R.id.lblEmail);
        ...
        lblGetNewCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AsyncGetNewCode().execute(email);
            }
        });
        ...
        btnValidationCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("EJVH code", txtValidationCode.getText().toString().trim());
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frm = new Intent(Act_ResetPasswordValidation.this,Act_Login.class);
                startActivity(frm);
                finish();
            }
        });
    ...
    private class AsyncGetNewCode extends AsyncTask<String, Integer, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            parametros.add(1, "UpdateResetPasswordCode");
            ...
            try {
                ...
                switch (result) {
                    case "OK":
                        ...
                        return 1;
                    default:
                        Log.d("EJVH newCode1", json.get("Message").toString());
                        publishProgress(2);
                        return 0;
                }
            } catch (JSONException e) {
                Log.d("EJVH newCode2", e.getMessage());
                publishProgress(2);
                return 0;
            }
        }
    ...
    private class AsyncSendValidationCode extends AsyncTask<String, Integer, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            parametros.add(2, "ConfirmResetPasswordCode");
    ...
    private void mostrarMensaje(boolean isWelcome, DialogType dialogType, int icon, String message){
        try{
            if(isWelcome){
                ...
                villaDialog = new VillaDialog(Act_ResetPasswordValidation.this, VillaDialog.DialogType.MESSAGE, message,icon);
                ...
                CountDownTimer timer = new CountDownTimer(3000,1000) {
                    ...
                    public void onFinish() {
                        Intent frm = new Intent(Act_ResetPasswordValidation.this,Act_ChangePassword.class);
                ...
                if(dialogType == DialogType.PROGRESS){
                    ...
                    villaDialog = new VillaDialog(Act_ResetPasswordValidation.this, VillaDialog.DialogType.PROGRESS, message);
                    villaDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                    villaDialog.setCanceledOnTouchOutside(false);
                    villaDialog.show();
